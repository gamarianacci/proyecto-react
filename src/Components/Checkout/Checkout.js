...
export function Checkout() {
    ...
    return (
        <>
            {ventaId ?
                <h2 className="formatoH2">Tu pedido ha sido realizado. Te vamos a contactar a la brevedad para definir método de pago y envío. El ID de tu compra es: {ventaId}.
